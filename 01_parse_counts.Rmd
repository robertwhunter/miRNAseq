...
We then filter out any genes that are not expressed at high abundance.  

```{r filter_manual_archived}
...
Median library size before filtering = `r libsize_raw`; and after filtering = `r libsize_filtered`.  
